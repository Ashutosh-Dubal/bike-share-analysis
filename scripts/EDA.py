...
plt.xlim(0, 60)
plt.tight_layout()
plt.savefig("visuals/trip_duration_dist.png")
plt.clf()
...
plt.ylabel("Number of Trips")
plt.tight_layout
plt.savefig("visuals/trips_by_hour.png")
plt.clf()
...
plt.ylabel("Number of Trips")
plt.tight_layout()
plt.savefig("visuals/trips_by_day.png")
plt.clf()

sns.countplot(x="user_type", data=df)
plt.title("Trips by User Type")
plt.tight_layout()
plt.savefig("visuals/user_type_breakdown.png")
plt.clf()
...
plt.tight_layout()
plt.savefig("visuals/top_start_stations.png")
plt.clf()
...
plt.ylabel("Number of Trips")
plt.tight_layout()
plt.savefig("visuals/trips_by_month.png")
plt.clf()
...
plt.ylabel("Route")
plt.tight_layout()
plt.savefig("visuals/top_10_routes.png")
plt.clf()
...
plt.tight_layout()
plt.savefig("visuals/trips_by_day_user_type.png")
plt.clf()
...
sns.countplot(
    ...
    hue="user_type",
    order=month_order,
    palette="Set2"  # Optional: any color palette
)
...
plt.tight_layout()
plt.savefig("visuals/trips_by_month_user_type.png")
plt.clf()
...
plt.legend(title="User Type")
plt.tight_layout()
plt.savefig("visuals/trips_by_hour_user_type.png")
plt.clf()
